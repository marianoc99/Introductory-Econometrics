...
(C2)(i)
load("C:/Users/carmo/OneDrive/Escritorio/S/R data sets for 5e/bwght.RData")
View(data)
...
No, this is not a good measure of the "typical" woman, since most of them
dont even smoke.
...
This is not a good measure either given the fact that most of the women do
not smoke
...
The mean is equal to 13.19. This mean is computed from 1192 elements,
given the fact that the others may not have been able to answer.
